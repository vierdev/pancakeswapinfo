...
export interface BaseOFTWithFeeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BP_DENOMINATOR"
      | "NO_EXTRA_GAS"
...
export interface BaseOFTWithFee extends BaseContract {
  connect(runner?: ContractRunner | null): BaseOFTWithFee;

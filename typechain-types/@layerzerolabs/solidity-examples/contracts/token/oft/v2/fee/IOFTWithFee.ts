...
export interface IOFTWithFeeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "circulatingSupply"
...
export interface IOFTWithFee extends BaseContract {
  connect(runner?: ContractRunner | null): IOFTWithFee;

...
export interface IPancakeV3FactoryInterface extends utils.Interface {
  functions: {
...
export type FeeAmountExtraInfoUpdatedEventFilter =
  TypedEventFilter<FeeAmountExtraInfoUpdatedEvent>;
...
export type SetLmPoolDeployerEvent = TypedEvent<
  [string],
  SetLmPoolDeployerEventObject
>;

export type SetLmPoolDeployerEventFilter =
  TypedEventFilter<SetLmPoolDeployerEvent>;
...
export interface IPancakeV3Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeV3FactoryInterface;
  ...
  filters: {
    ...
    "SetLmPoolDeployer(address)"(
      lmPoolDeployer?: PromiseOrValue<string> | null
    ): SetLmPoolDeployerEventFilter;
    SetLmPoolDeployer(
      lmPoolDeployer?: PromiseOrValue<string> | null
    ): SetLmPoolDeployerEventFilter;

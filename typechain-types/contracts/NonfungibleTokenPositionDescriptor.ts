...
export interface NonfungibleTokenPositionDescriptorInterface
  ...
  functions: {
    ...
    "nftDescriptorEx()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "nftDescriptorEx",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface NonfungibleTokenPositionDescriptor extends BaseContract {
  ...
  functions: {
    ...
    nftDescriptorEx(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    nftDescriptorEx(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    nftDescriptorEx(overrides?: CallOverrides): Promise<PopulatedTransaction>;

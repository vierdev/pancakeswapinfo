...
export interface TestPancakeswapCalleeInterface extends utils.Interface {
  functions: {
...
export interface TestPancakeswapCallee extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPancakeswapCalleeInterface;

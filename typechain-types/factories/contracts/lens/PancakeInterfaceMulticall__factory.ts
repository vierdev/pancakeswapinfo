...
import type {
  ...
  PancakeInterfaceMulticallInterface,
} from "../../../contracts/lens/PancakeInterfaceMulticall";
...
type PancakeInterfaceMulticallConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: PancakeInterfaceMulticallConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class PancakeInterfaceMulticall__factory extends ContractFactory {
  constructor(...args: PancakeInterfaceMulticallConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<PancakeInterfaceMulticall> {
    return super.deploy(overrides || {}) as Promise<PancakeInterfaceMulticall>;
  }
  ...
  override attach(address: string): PancakeInterfaceMulticall {
    return super.attach(address) as PancakeInterfaceMulticall;
  }
  override connect(signer: Signer): PancakeInterfaceMulticall__factory {
    return super.connect(signer) as PancakeInterfaceMulticall__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PancakeInterfaceMulticallInterface {
    return new utils.Interface(_abi) as PancakeInterfaceMulticallInterface;
  }
  static connect(
    address: string,
